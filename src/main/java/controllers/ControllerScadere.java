...
public class ControllerScadere {
    ...
    public ControllerScadere(MainView mainView) {
        this.mainView = mainView;

        this.mainView.addScadereListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    for (Monom x : polinom2.getParts()) {
                        x.setCoeficient(-x.getCoeficient());
                    }
